...
public class ScrabblePanel extends JPanel
{
   ...
   */
   public ScrabblePanel()
   {
      try
      {
         ...
         //Server Stuff
         Socket theSocket = new Socket(ScrabbleIP.IPADDY, ScrabbleIP.PORTNUM);
         //reads from server
   ...
   */
   public void paintComponent(Graphics g)
   {
      ...
      drawBoard();
      drawRackLetters();
      drawBoardLetters(BoardSpaces, true);
      drawBoardLetters(CurrentBoardMoves, false);
      drawLetterPile();
      drawScoreSheet();
      drawMessage();
   }
   ...
   private void drawBoardLetters(Letter[][] Tile, boolean black)
   {
      for(int a = 0; a < 15; a++)
      {
         for(int b = 0; b < 15; b++)
