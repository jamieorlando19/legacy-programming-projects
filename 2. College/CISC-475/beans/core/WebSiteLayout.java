...
public class WebSiteLayout {
   ...
   */
   ...
   /**
   *  Sets the flag to include a messageboard
   *  @param b the flag
   */
   public void sethasMessageBoard(boolean b) {
      hasMessageBoard = b;
   }

   /**
   *  Gets the messageboard flag
   *  @return the messageboard flag
   */
   public boolean gethasMessageBoard() { 
   ...
   public boolean select(String url) throws SQLException {
      ...
      try {
         ...
         if(results.next())
         {
           ...
           sethasMessageBoard(results.getBoolean(5));
